<%@ Page Language="vb" AutoEventWireup="false" ValidateRequest="false"  CodeBehind="HelpAdmin.aspx.vb" Inherits="QD.HelpAdmin" %>
...
<body>
    ...
    <div>
           <asp:Xml ID="xslcontent" runat="server" Visible="false" DocumentSource="~/StatData.xml" TransformSource="~/Helpadmin.xslt"></asp:Xml>
    </div>
